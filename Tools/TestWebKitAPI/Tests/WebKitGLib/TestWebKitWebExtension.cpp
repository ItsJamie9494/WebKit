...
static void testActionParsing(Test*, gconstpointer)
{
    ...
    auto parseWithIcon = [&](const gchar* manifestString, Vector<uint8_t> imageData) {
        return webkitWebExtensionCreateWithBytes({
            { "manifest.json"_s, String::fromLatin1(manifestString).utf8().span() },
            { "test.png"_s, imageData.span() }
        }, &error.outPtr());
    };

    auto* extension = parse("{ \"manifest_version\": 2, \"name\": \"Test\", \"version\": \"1.0\", \"description\": \"Test description\" }");
    g_assert_no_error(error.get());
    g_assert_null(webkit_web_extension_get_display_action_label(extension));
    g_assert_null(webkit_web_extension_get_action_icon(extension, 16, 16));
    ...
    g_assert_no_error(error.get());
    g_assert_cmpstr(webkit_web_extension_get_display_action_label(extension), ==, "Button Title");
    g_assert_null(webkit_web_extension_get_action_icon(extension, 16, 16));
    ...
    auto imageData = Util::makePNGData(16, 16, 0x008000);
    ...
    g_assert_no_error(error.get());
    g_assert_cmpstr(webkit_web_extension_get_display_action_label(extension), ==, "Button Title");
    g_assert_nonnull(webkit_web_extension_get_action_icon(extension, 16, 16));
...
static void testPermissionsParsing(Test*, gconstpointer)
{
    ...
    g_assert_null(webkit_web_extension_get_requested_permission_match_patterns(extension));
    g_assert_null(optionalPermissions);
    g_assert_null(webkit_web_extension_get_optional_permission_match_patterns(extension));
    ...
    optionalPermissions = webkit_web_extension_get_optional_permissions(extension);
    g_assert_nonnull(requestedPermissions);
    g_assert_cmpint(g_list_length(webkit_web_extension_get_requested_permission_match_patterns(extension)), ==, 1);
    g_assert_cmpstr(webkit_web_extension_match_pattern_get_string(static_cast<WebKitWebExtensionMatchPattern*>(g_list_nth_data(webkit_web_extension_get_requested_permission_match_patterns(extension), 0))), ==, "http://www.webkit.org/");
    g_assert_null(optionalPermissions);
    g_assert_null(webkit_web_extension_get_optional_permission_match_patterns(extension));
    g_assert_cmpstr(requestedPermissions[0], ==, "tabs");
    g_assert_null(requestedPermissions[1]);
    ...
    g_assert_null(webkit_web_extension_get_requested_permission_match_patterns(extension));
    g_assert_nonnull(optionalPermissions);
    g_assert_cmpint(g_list_length(webkit_web_extension_get_optional_permission_match_patterns(extension)), ==, 1);
    g_assert_cmpstr(webkit_web_extension_match_pattern_get_string(static_cast<WebKitWebExtensionMatchPattern*>(g_list_nth_data(webkit_web_extension_get_optional_permission_match_patterns(extension), 0))), ==, "http://www.webkit.org/");
    g_assert_cmpstr(optionalPermissions[0], ==, "tabs");
    g_assert_null(optionalPermissions[1]);
    ...
    g_assert_cmpstr(webkit_web_extension_match_pattern_get_string(static_cast<WebKitWebExtensionMatchPattern*>(g_list_nth_data(webkit_web_extension_get_requested_permission_match_patterns(extension), 0))), ==, "http://www.webkit.org/");
    g_assert_cmpint(g_list_length(webkit_web_extension_get_optional_permission_match_patterns(extension)), ==, 1);
    g_assert_cmpstr(webkit_web_extension_match_pattern_get_string(static_cast<WebKitWebExtensionMatchPattern*>(g_list_nth_data(webkit_web_extension_get_optional_permission_match_patterns(extension), 0))), ==, "http://www.example.com/");
    ...
    g_assert_cmpint(g_list_length(webkit_web_extension_get_requested_permission_match_patterns(extension)), ==, 1);
    g_assert_cmpstr(webkit_web_extension_match_pattern_get_string(static_cast<WebKitWebExtensionMatchPattern*>(g_list_nth_data(webkit_web_extension_get_requested_permission_match_patterns(extension), 0))), ==, "https://webkit.org/");
    g_assert_null(webkit_web_extension_get_optional_permission_match_patterns(extension));
...
static void testBackgroundParsing(Test*, gconstpointer)
{
    ...
    g_assert_false(webkit_web_extension_get_has_service_worker_background_content(extension));
    g_assert_false(webkit_web_extension_get_has_modular_background_content(extension));
    g_assert_no_error(error.get());
    ...
    g_assert_true(webkit_web_extension_get_has_background_content(extension));
    g_assert_false(webkit_web_extension_get_has_persistent_background_content(extension));
    g_assert_true(webkit_web_extension_get_has_service_worker_background_content(extension));
    g_assert_false(webkit_web_extension_get_has_modular_background_content(extension));
    g_assert_no_error(error.get());
    ...
    g_assert_false(webkit_web_extension_get_has_persistent_background_content(extension));
    g_assert_true(webkit_web_extension_get_has_service_worker_background_content(extension));
    g_assert_true(webkit_web_extension_get_has_modular_background_content(extension));
    g_assert_no_error(error.get());
...
static void testBackgroundPreferredEnvironmentParsing(Test*, gconstpointer)
{
    ...
    auto* extension = parse("{ \"manifest_version\": 3, \"background\": { \"preferred_environment\": [ \"service_worker\", \"document\" ], \"service_worker\": \"background.js\", \"scripts\": [ \"background.js\" ], \"page\": \"background.html\" }, \"name\": \"Test\", \"version\": \"1.0\", \"description\": \"Test description\" }");
    g_assert_true(webkit_web_extension_get_has_background_content(extension));
    g_assert_true(webkit_web_extension_get_has_service_worker_background_content(extension));
    g_assert_no_error(error.get());
...
static void testCommandsParsing(Test*, gconstpointer)
{
    ...
    auto* extension = parse("{ \"commands\": { \"show-popup\": { \"suggested_key\": { \"default\": \"Ctrl+Shift+P\", \"linux\": \"Ctrl+Shift+A\" }, \"description\": \"Show the popup\" } }, \"manifest_version\": 3, \"name\": \"Test\", \"description\": \"Test\", \"version\": \"1.0\" }");
    g_assert_true(webkit_web_extension_get_has_commands(extension));
    g_assert_no_error(error.get());
    ...
    g_assert_false(webkit_web_extension_get_has_commands(extension));
    g_assert_no_error(error.get());
...
static void testDeclarativeNetRequestParsing(Test*, gconstpointer)
{
    ...
    auto* extension = parse("{ \"declarative_net_request\": { \"rule_resources\": [{ \"id\": \"test\", \"enabled\": true, \"path\": \"rules.json\" }] }, \"manifest_version\": 3, \"name\": \"Test\", \"description\": \"Test\", \"version\": \"1.0\", \"permissions\": [ \"declarativeNetRequest\"] }");
    g_assert_true(webkit_web_extension_get_has_content_modification_rules(extension));
    g_assert_no_error(error.get());
    ...
    g_assert_false(webkit_web_extension_get_has_content_modification_rules(extension));
...
static void testExternallyConnectableParsing(Test*, gconstpointer)
{
    ...
    auto* extension = parse("{ \"externally_connectable\": {}, \"manifest_version\": 3, \"name\": \"Test\", \"description\": \"Test\", \"version\": \"1.0\" }");
    g_assert_null(webkit_web_extension_get_all_requested_match_patterns(extension));
    g_assert_error(error.get(), WEBKIT_WEB_EXTENSION_ERROR, WEBKIT_WEB_EXTENSION_ERROR_INVALID_MANIFEST_ENTRY);
    ...
    g_assert_cmpint(g_list_length(webkit_web_extension_get_all_requested_match_patterns(extension)), ==, 1);
    g_assert_error(error.get(), WEBKIT_WEB_EXTENSION_ERROR, WEBKIT_WEB_EXTENSION_ERROR_INVALID_MANIFEST_ENTRY);
    ...
    g_assert_cmpint(g_list_length(webkit_web_extension_get_all_requested_match_patterns(extension)), ==, 1);
    g_assert_no_error(error.get());
    g_assert_true(webkit_web_extension_match_pattern_matches_pattern(static_cast<WebKitWebExtensionMatchPattern*>(g_list_nth_data(webkit_web_extension_get_all_requested_match_patterns(extension), 0)), matchingPattern, WEBKIT_WEB_EXTENSION_MATCH_PATTERN_OPTIONS_NONE));
