...
{
    switch (apiError) {
    case static_cast<int>(WebKit::WebExtensionMatchPattern::Error::InvalidScheme):
        return WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_SCHEME;
    case static_cast<int>(WebKit::WebExtensionMatchPattern::Error::InvalidHost):
        return WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_HOST;
    case static_cast<int>(WebKit::WebExtensionMatchPattern::Error::InvalidPath):
        return WEBKIT_WEB_EXTENSION_MATCH_PATTERN_ERROR_INVALID_PATH;
    case static_cast<int>(WebKit::WebExtensionMatchPattern::Error::Unknown):
    default:
