 ...
 * 
 * Represents a way to specify a group of URLs for use in Web Extensions.
 * 
...
struct _WebKitWebExtensionMatchPattern {
    _WebKitWebExtensionMatchPattern(RefPtr<WebExtensionMatchPattern>&& matchPattern)
...
WebKitWebExtensionMatchPattern* webkitWebExtensionMatchPatternCreate(Ref<WebExtensionMatchPattern>& matchPattern)
{
    ...
    WebKitWebExtensionMatchPattern* pattern = static_cast<WebKitWebExtensionMatchPattern*>(fastMalloc(sizeof(WebKitWebExtensionMatchPattern)));
    new (pattern) WebKitWebExtensionMatchPattern(static_pointer_cast<WebExtensionMatchPattern>(apiMatchPattern));
    return pattern;
}
...
/**
 * webkit_web_extension_match_pattern_new_with_parts:
 ...
 */
WebKitWebExtensionMatchPattern* webkit_web_extension_match_pattern_new_with_parts(const gchar* scheme, const gchar* host, const gchar* path, GError** error)
{
    if (!error)
