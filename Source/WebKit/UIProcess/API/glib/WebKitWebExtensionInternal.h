...
WK_EXPORT WebKitWebExtension* webkitWebExtensionCreate(const& HashMap<String, String> resources, GError**);
WK_EXPORT WebKitWebExtension* webkitWebExtensionCreateWithBytes(const& HashMap<String, std::span<const uint8_t>> resources, GError**);
